...
/**
 * Tests for {@link ControllerImpl} to check if it initializes correctly
 * and if all the methods inside the {@link ControllerImpl} is built accurately.
 */
public class ControllerTest {
  ...
  /**
   * An example of an image processor controller that is constructed well,
  ...
  public void testConstructorNull1() {
    this.setup();
    new ControllerImpl(model, null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructorNull2() {
    this.setup();
    new ControllerImpl(null, input);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testLoadInvalidFile() {
    this.setup();
    this.controller.load("ImageProcessing/invalid.ppm", "invalid");
  }

  @Test(expected = IllegalArgumentException.class)
  public void testLoadInvalidPPMFile() {
    this.setup();
    this.controller.load("ImageProcessing/invalidPPM.pm", "invalidPPM");
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSaveNothing() {
    this.setup();
    this.controller.save("res/house.ppm", null);
  }
  ...
  @Test
  public void testFilteringSharpen() {
    this.setup();
  ...
  @Test
  public void testColorTransGreyscale() {
    this.setup();
  ...
  @Test
  public void testColorTransSepia() {
    this.setup();
